...
var varGlobale = varChien = varChienDeux = varAne = varAneDeux = varChat = varChatDeux = varLama = varLamaDeux = 
varLapins = varLapinsDeux = varLionne = varLionneDeux = varOurs = varOursDeux = 100;
var compteur = 1;
var largeur = -54;
var hauteur = 100;
...
for(i=0;i<cards.length;i++){
	...
	'px; top: '+hauteur+'px;"><div id="black'+cards[i]+'" class="black" style="left:'+largeur+'px; top: '+hauteur+'px"></div>'); // Ecrit le html
}
...
if(dispo){							//	Si on click sur la div #blackAne, alors : 
